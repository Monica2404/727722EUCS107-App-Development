...
import { updateData, deleteData, showData,getData } from '../assets/JSON/API';
...
const AdminUsers = () => {
    ...
    const fetchUsers = async () => {
            ...
            const UserData = data.filter(user => user.userRole === 'User');
            setUsers(UserData);
    };
        ...
        {editUser && (
            <div className="edit-modal show">
                <div className="edit-form">
                    ...
                    <label>
                        Name:
                        <input type="text" name="uname" value={editUser.username} onChange={handleChange} />
                    </label>
                    <label>
                        Email:
